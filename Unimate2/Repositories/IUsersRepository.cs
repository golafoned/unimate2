...
namespace UniMate2.Repositories
{
    public interface IUsersRepository
    {
        ...
        Task<List<User>> GetUsersOrderedByLikesReceivedAsync();
        Task<List<User>> GetUsersOrderedByLikesGivenAsync();
        Task<Dictionary<string, int>> GetUserLikesReceivedCountAsync();
        Task<Dictionary<string, int>> GetUserLikesGivenCountAsync();
    }
}
